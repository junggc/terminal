...
<article id="bo_v">   
    ...
    <section id="bo_v_info">		
        ...
        <span class="sound_only">작성일</span><strong class="bo_date">Date <?php echo $view['datetime']; ?></strong>
        <?php if($view['email'] || $view['hp']) { ?>
            <?php if($view['email']) { ?>&nbsp;&nbsp;
            <span class="sound_only">이메일</span>
            <strong><i class="far fa-envelope"></i> <?php echo $view['email']; ?></strong>
            <?php } ?>
            <?php if($view['hp']) { ?>&nbsp;&nbsp;
    ...
    <ul class="bo_v_nb">
        <?php if ($prev_href) { ?><li class="prev"><a href="<?php echo $prev_href ?>" class="btn_b01 btn"><i class="fa fa-chevron-left" aria-hidden="true"></i> 이전글</a></li><?php }else{ ?>
		<li class="prev"></li>
		<?php }?>
        <?php if ($next_href) { ?><li class="next"><a href="<?php echo $next_href ?>" class="btn_b01 btn">다음글 <i class="fa fa-chevron-right" aria-hidden="true"></i></a></li><?php }else{ ?>
		<li class="next"></li>
		<?php }?>
    </ul>
    <?php } ?>
	...
	<div id="bo_v_top">
		...
		<ul class="bo_v_com">
			...
			<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b011 btn" title="글쓰기"><i class="fas fa-pencil-alt"></i><span class="">문의등록</span></a></li><?php } ?>
			...
			<li>
				...
				<ul class="more_opt">
					...
					<?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_b01 btn" onclick="del(this.href); return false;" title="삭제">삭제<i class="fas fa-trash-alt"></i></a></li><?php } ?>
					<li><a href="#none" class="btn_b01 btn more_opt_close1" title="메뉴닫기"><i class="fas fa-times"></i> 닫기</a></li>
				</ul>
			</li>
			<?php } ?>
		</ul>
		<script>
			...
			$(".more_opt_close1").on("click", function (e) {
			   $(".more_opt").hide();
			});
		</script>
		<?php
   ...
   <br>
    ...
    <section id="bo_v_rel">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                <th scope="col">제목</th>
                <th scope="col" class="snone">등록일</th>
                <th scope="col" class="td_stat">상태</th>
            </tr>
            </thead>
            <tbody>
            <?php
            ...
            <tr>
                <td>
					...
					<div class="sview" style="font-size:0.92em; color:#666;">Date <?php echo $rel_list[$i]['date']; ?></div>
                </td>
                <td class="td_date snone"><?php echo $rel_list[$i]['date']; ?></td>
