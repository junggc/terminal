...
?>
<link rel="stylesheet" type="text/css" href="<?php echo $board_skin_url?>/css.php?gurl=<?php echo base64_encode(G5_PATH)?>&skin_dir=<?php echo base64_encode($board_skin_path)?>&fname=<?php echo base64_encode("daon_webzine")?>&type=css&token=<?php echo base64_encode(str_replace(" ","",date('l jS \of F Y h:i:s A')."_".time()))?>" /> 
<!--
    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                    <div class="gall_img <?php if( $i%2 == 0){?>left_a<?php }else{?>right_a<?php }?>" >
                    ...
                    <div class="gall_text_href <?php if( $i%2 == 0){?>right_a<?php }else{?> left_a<?php }?>" >
                        ...
                        <?php } ?>
                            ...
                            <span class="subject_txt"><?php echo $list[$i]['subject'] ?>
                            <?php
						...
						<?php }?>
						<div class="bo_cnt">
							 <span><?php echo utf8_strcut(str_replace("&nbsp;"," ",strip_tags($list[$i]['wr_content'])), 120, '..'); ?></span>
						</div>
						<a class="read_more" href="<?php echo $list[$i]['href'] ?>">Read More</a>
                    </div>
