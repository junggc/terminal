...
$theme_license = "daontheme_ver2_#07_2022-01-24";  
$css_license = "0Y6tV1D";
$GNUBOARD_VERSION = "5.4.22"; //본 테마에 적용된 그누보드 버전입니다.
...
if(!preg_match("/\/adm\/theme\.php/", $_SERVER['PHP_SELF']) && !preg_match("/\/adm\/theme_config_load\.php/", $_SERVER['PHP_SELF']) && !preg_match("/\/adm\/theme_update\.php/", $_SERVER['PHP_SELF'])){
	...
	$arrow_remote_addr = isset($arrow_remote_addr) ? $arrow_remote_addr : '';
	$wcs_code = isset($wcs_code) ? $wcs_code : '';
	$common_css_src = isset($common_css_src) ? $common_css_src : '';
	$youtube_bg = isset($youtube_bg) ? $youtube_bg : '';
	$youtube_idx = isset($youtube_idx) ? $youtube_idx : '';
