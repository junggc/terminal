...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
			...
			<span class=" <?php echo ($list[$i]['wr_2']=="완료" ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($list[$i]['wr_2']=="완료" ? '<i class="fa fa-check-circle" aria-hidden="true"></i> 완료' : '<i class="fa fa-times-circle" aria-hidden="true"></i> 접수'); ?></span>
			<?php }else{?>
			<span class="txt_rdy"><i class="fas fa-bell"></i> 공지</span>
			<?php }?>
			</td>
        </tr>
        <?php } ?>
