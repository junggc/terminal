...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
		...
		<div style="text-align:center; margin:20px 0;">
			...
			<span class="sound_only">조회</span><strong>Hit <?php echo number_format($view['wr_hit']) ?></strong>&nbsp;&nbsp;
	        ...
	        <ul class="btn_bo_user bo_v_com">
	        	...
	        	<li>
		        	...
		        	<ul class="more_opt is_view_btn"> 
			            ...
			            <?php if ($delete_href) { ?><li class="wid_s"><a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;">삭제<i class="fa fa-trash-o"></i></a></li><?php } ?>
			            ...
			            <?php if ($move_href) { ?><li class="wid_s"><a href="<?php echo $move_href ?>" onclick="board_move(this.href); return false;">이동<i class="fa fa-arrows"></i></a></li><?php } ?>
			            <?php if ($search_href) { ?><li class="wid_s"><a href="<?php echo $search_href ?>">검색<i class="fa fa-search" aria-hidden="true"></i></a></li><?php } ?>
						<li class="wid_s"><a href="#none" class="more_opt_close1">닫기<i class="fa fa-times"></i></a></li>
			        </ul> 
	        	</li>
	        	<?php } ?>
	        </ul>			
