...
<!--		<p class="stitle">고객을 가장 먼저 생각하는 기업, <br class="sview">고객이 먼저 자랑하는 기업이 되겠습니다.</p>-->
		...
		<div class="company">
			<div class="ceo_img"><img src="<?php echo G5_THEME_URL;?>/html/company/image/인사말.png"></div>
			<div class="ceo_txt">
				<h2>
					안녕하십니까?<br>
				...
				<p>
                    ...
                    2008년 창사 이래로 건축구조물해체와 석면해체제거업을 주 사업으로 하여 지역과 함께 성장해 왔습니다.<br>
			...
			<div class="summary">
				...
				<div class="lview">
					...
					<tr>
						...
						<td>2008년</td>
						<th>사업영역</th>
						<td>건축구조물 해체, 내부철거공사, 석면철거, 부분철거</td>
					</tr>
<!--					<tr>-->
<!--						<th>사업장규모</th>-->
<!--						<td>대지 00평 / 건평 00평</td>-->
