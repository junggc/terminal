                    ...
                    <div class="gall_img" >
                        ...
                        <?php } else {
							...
							if($youtube_id){
								...
								$img_content = '<img src="https://img.youtube.com/vi/'.$youtube_id.'/mqdefault.jpg" alt="'.$thumb['alt'].'" style="width:'.$board['bo_gallery_width'].'px; height:'.$board['bo_gallery_height'].'px; ">';
								
							}

						?>
						<a class="popup-youtube"  href="https://www.youtube.com/watch?v=<?php echo $youtube_id?>" rel="<?php echo $youtube_id?>">
						<?php
                            echo run_replace('thumb_image_tag', $img_content, $thumb);    unset($matches, $yurl, $youtube_id);
                        }
                         ?>	
